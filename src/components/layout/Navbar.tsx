        ...
        <div className="hidden h-(--header-height) items-center justify-between gap-6 px-6 md:flex xl:px-8">
          ...
          <div className="flex shrink-0 items-center gap-3">
            <form onSubmit={submitSearch} className="relative w-64 xl:w-72">
              ...
              />
              <kbd className="pointer-events-none absolute right-2.5 top-1/2 hidden -translate-y-1/2 rounded-md border border-[#E8ECEA] bg-[#EFF3F1] px-1.5 py-0.5 text-[18px] font-medium text-[#98A2B3] lg:block">
                ⏎
              </kbd>
            </form>
