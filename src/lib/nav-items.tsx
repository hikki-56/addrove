...
export const navItems: NavItem[] = [
  {
    ...
    staffIcon: (
      <div className="w-5 h-5 rounded bg-indigo-50 border border-indigo-200 flex items-center justify-center p-0.5">
  ...
  },
  {
    ...
    staffIcon: (
      <div className="w-5 h-5 rounded bg-blue-50 border border-blue-200 flex items-center justify-center p-0.5">
  ...
  },
  {
    ...
    staffIcon: (
      <div className="w-5 h-5 rounded bg-amber-50 border border-amber-200 flex items-center justify-center p-0.5">
  ...
  },
  {
    ...
    staffIcon: (
      <div className="w-5 h-5 rounded bg-rose-50 border border-rose-200 flex items-center justify-center p-0.5">
