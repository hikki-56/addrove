...
export const CreateUserSchema = z.object({
  ...
  role: z.enum(["ADMIN", "MANAGER", "APPROVER", "WAREHOUSE_STAFF", "PACKER", "STAFF", "VIEWER"]).default("STAFF"),
...
export const UpdateUserSchema = z.object({
  ...
  role: z.enum(["ADMIN", "MANAGER", "APPROVER", "WAREHOUSE_STAFF", "PACKER", "STAFF", "VIEWER"]).optional(),
