...
<div align="center">
  ...
  <p><em>ภาพที่ 1: หน้าจอจริงในการกรอกรหัส PIN 4 หลัก (ตัวอย่างรหัสพนักงาน: 5555 คุณธนพล วงศ์สว่าง) พร้อมป้ายระบุโกดัง 1</em></p>
</div>
...
3. แตะแป้นตัวเลขบนหน้าจอเพื่อใส่ **รหัส PIN ประจำตัว 4 หลัก** (เช่น แตะรหัส `5555`)
4. เมื่อกดครบ 4 หลัก ระบบจะตรวจสอบและนำเข้าสู่หน้าจอการทำงานของโกดังนั้นทันที
