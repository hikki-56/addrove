...
*ภาพที่ 1: หน้าจอ Sign In ของผู้ดูแลระบบ*

- เข้า URL ระบบที่หน้า `/login`
- กรอก Username / Email และ Password แล้วคลิก **[ Sign In ]**
...
*ภาพที่ 3.1: รายการเอกสารรับเข้าสินค้าที่รอการตรวจสอบอนุมัติ (`/approvals`)*

![หน้าต่างตรวจนับและกดอนุมัติ RCV](./images/10-admin-rcv-modal.png)
*ภาพที่ 3.2: หน้าต่างสรุปรายละเอียดสินค้า ตำแหน่งชั้นวาง และปุ่มกดอนุมัติ*
