...
var ALLOWED_SHEETS = [
  ...
  // แท็บระบบใบผลิต (สร้างอัตโนมัติเมื่อมีการเขียนครั้งแรก)
  '\u0e43\u0e1a\u0e1c\u0e25\u0e34\u0e15',
  '\u0e43\u0e1a\u0e1c\u0e25\u0e34\u0e15\u005f\u0e27\u0e31\u0e15\u0e16\u0e38\u0e14\u0e34\u0e1a',
  '\u0e15\u0e23\u0e27\u0e08\u0e01\u0e32\u0e23\u0e1c\u0e25\u0e34\u0e15',
  '\u0e2a\u0e34\u0e19\u0e04\u0e49\u0e32\u0e40\u0e2a\u0e35\u0e22',
...
// แท็บระบบใบผลิต — สร้างอัตโนมัติพร้อมหัวตารางเมื่อยังไม่มีในสเปรดชีต (แท็บอื่นยัง fail-closed เหมือนเดิม)
var PRODUCTION_SHEET_HEADERS = {
  '\u0e43\u0e1a\u0e1c\u0e25\u0e34\u0e15': [
    '\u0e40\u0e25\u0e02\u0e17\u0e35\u0e48\u0e43\u0e1a\u0e1c\u0e25\u0e34\u0e15', 'document_id', '\u0e27\u0e31\u0e19\u0e17\u0e35\u0e48\u0e2a\u0e31\u0e48\u0e07\u0e1c\u0e25\u0e34\u0e15', '\u0e2a\u0e16\u0e32\u0e19\u0e30', '\u0e23\u0e2b\u0e31\u0e2a\u0e2a\u0e34\u0e19\u0e04\u0e49\u0e32', '\u0e0a\u0e37\u0e48\u0e2d\u0e2a\u0e34\u0e19\u0e04\u0e49\u0e32', '\u0e2b\u0e19\u0e48\u0e27\u0e22', '\u0e17\u0e35\u0e48\u0e2a\u0e31\u0e48\u0e07\u0e1c\u0e25\u0e34\u0e15', '\u0e1c\u0e25\u0e34\u0e15\u0e44\u0e14\u0e49\u0e08\u0e23\u0e34\u0e07', '\u0e02\u0e2d\u0e07\u0e40\u0e2a\u0e35\u0e22', '\u0e1c\u0e39\u0e49\u0e2a\u0e31\u0e48\u0e07\u0e1c\u0e25\u0e34\u0e15', '\u0e2a\u0e23\u0e49\u0e32\u0e07\u0e40\u0e21\u0e37\u0e48\u0e2d', '\u0e2b\u0e21\u0e32\u0e22\u0e40\u0e2b\u0e15\u0e38', '\u0e40\u0e28\u0e29\u0e27\u0e31\u0e15\u0e16\u0e38\u0e14\u0e34\u0e1a\u0e44\u0e1b\u0e42\u0e01\u0e14\u0e31\u0e07', '\u0e40\u0e28\u0e29\u0e27\u0e31\u0e15\u0e16\u0e38\u0e14\u0e34\u0e1a\u0e15\u0e33\u0e41\u0e2b\u0e19\u0e48\u0e07'
  ],
  '\u0e43\u0e1a\u0e1c\u0e25\u0e34\u0e15\u005f\u0e27\u0e31\u0e15\u0e16\u0e38\u0e14\u0e34\u0e1a': [
    '\u0e40\u0e25\u0e02\u0e17\u0e35\u0e48\u0e43\u0e1a\u0e1c\u0e25\u0e34\u0e15', '\u0e23\u0e2b\u0e31\u0e2a\u0e27\u0e31\u0e15\u0e16\u0e38\u0e14\u0e34\u0e1a', '\u0e0a\u0e37\u0e48\u0e2d\u0e27\u0e31\u0e15\u0e16\u0e38\u0e14\u0e34\u0e1a', '\u0e2b\u0e19\u0e48\u0e27\u0e22', '\u0e15\u0e32\u0e21\u0e41\u0e1c\u0e19', '\u0e43\u0e0a\u0e49\u0e08\u0e23\u0e34\u0e07', '\u0e04\u0e07\u0e40\u0e2b\u0e25\u0e37\u0e2d\u0e15\u0e32\u0e21\u0e41\u0e1c\u0e19', '\u0e2d\u0e31\u0e1e\u0e40\u0e14\u0e17\u0e40\u0e21\u0e37\u0e48\u0e2d'
  ],
  '\u0e15\u0e23\u0e27\u0e08\u0e01\u0e32\u0e23\u0e1c\u0e25\u0e34\u0e15': ['\u0e40\u0e25\u0e02\u0e17\u0e35\u0e48\u0e43\u0e1a\u0e1c\u0e25\u0e34\u0e15', '\u0e23\u0e2d\u0e1a\u0e17\u0e35\u0e48', '\u0e27\u0e31\u0e19\u0e17\u0e35\u0e48\u0e2a\u0e48\u0e07\u0e1c\u0e25\u0e15\u0e23\u0e27\u0e08', '\u0e23\u0e2b\u0e31\u0e2a\u0e2a\u0e34\u0e19\u0e04\u0e49\u0e32', '\u0e02\u0e2d\u0e07\u0e14\u0e35', '\u0e02\u0e2d\u0e07\u0e40\u0e2a\u0e35\u0e22', '\u0e1b\u0e25\u0e32\u0e22\u0e17\u0e32\u0e07\u0e42\u0e01\u0e14\u0e31\u0e07', '\u0e15\u0e33\u0e41\u0e2b\u0e19\u0e48\u0e07', '\u0e1c\u0e39\u0e49\u0e23\u0e32\u0e22\u0e07\u0e32\u0e19', '\u0e2b\u0e21\u0e32\u0e22\u0e40\u0e2b\u0e15\u0e38\u0e1c\u0e39\u0e49\u0e23\u0e32\u0e22\u0e07\u0e32\u0e19', '\u0e2a\u0e16\u0e32\u0e19\u0e30\u0e23\u0e2d\u0e1a', '\u0e1c\u0e39\u0e49\u0e22\u0e37\u0e19\u0e22\u0e31\u0e19', '\u0e22\u0e37\u0e19\u0e22\u0e31\u0e19\u0e40\u0e21\u0e37\u0e48\u0e2d', '\u0e2b\u0e21\u0e32\u0e22\u0e40\u0e2b\u0e15\u0e38\u0e1c\u0e39\u0e49\u0e15\u0e23\u0e27\u0e08', '\u0e02\u0e2d\u0e1b\u0e34\u0e14\u0e43\u0e1a\u0e1c\u0e25\u0e34\u0e15', '\u0e40\u0e28\u0e29\u0e27\u0e31\u0e15\u0e16\u0e38\u0e14\u0e34\u0e1a\u0e44\u0e1b\u0e42\u0e01\u0e14\u0e31\u0e07', '\u0e40\u0e28\u0e29\u0e27\u0e31\u0e15\u0e16\u0e38\u0e14\u0e34\u0e1a\u0e15\u0e33\u0e41\u0e2b\u0e19\u0e48\u0e07'],
  '\u0e2a\u0e34\u0e19\u0e04\u0e49\u0e32\u0e40\u0e2a\u0e35\u0e22': [
    'waste_id', '\u0e40\u0e25\u0e02\u0e17\u0e35\u0e48\u0e43\u0e1a\u0e1c\u0e25\u0e34\u0e15', '\u0e23\u0e2d\u0e1a\u0e17\u0e35\u0e48', '\u0e27\u0e31\u0e19\u0e17\u0e35\u0e48', '\u0e23\u0e2b\u0e31\u0e2a\u0e2a\u0e34\u0e19\u0e04\u0e49\u0e32', '\u0e0a\u0e37\u0e48\u0e2d\u0e2a\u0e34\u0e19\u0e04\u0e49\u0e32', '\u0e08\u0e33\u0e19\u0e27\u0e19', '\u0e2b\u0e21\u0e32\u0e22\u0e40\u0e2b\u0e15\u0e38', '\u0e1c\u0e39\u0e49\u0e1a\u0e31\u0e19\u0e17\u0e36\u0e01', '\u0e1a\u0e31\u0e19\u0e17\u0e36\u0e01\u0e40\u0e21\u0e37\u0e48\u0e2d'
  ]
};
...
function getSheet(sheetName) {
  ...
  if (!sheet) {
    // Do NOT auto-create sheets — fail closed (ยกเว้นแท็บระบบใบผลิตที่ประกาศหัวตารางไว้)
    if (Object.prototype.hasOwnProperty.call(PRODUCTION_SHEET_HEADERS, sheetName)) {
      sheet = ss.insertSheet(sheetName);
      var headers = PRODUCTION_SHEET_HEADERS[sheetName];
